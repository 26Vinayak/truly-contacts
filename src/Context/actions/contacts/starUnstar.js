import { ADD_REMOVE_STAR_LOADING, ADD_REMOVE_STAR_SUCCESS, ADD_REMOVE_STAR_ERROR } from "../../../constants/actionTypes"
...
export default (id,is_favorite) => (dispatch) => {
    ...
    axiosInstance().patch(`/contacts/${id}`,{is_favorite}).then((res) => {
        dispatch({
